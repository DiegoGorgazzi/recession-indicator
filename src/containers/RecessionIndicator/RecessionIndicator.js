...
import {
  ...
  dateFormatConverter,
  deepJSONArrayClone
} from "../../shared/helperFunctions/helperFunctions";
        ...
        <div className={recessionIndicatorStyles.chartArea}>
          {this.isMobile ? (
            ...
            <FlexibleXYPlot
              ...
              colorType="linear"
              onMouseMove={
                this.isMobile ? null : this.crosshairRecOnlyDataHandler
              }
              onMouseLeave={() => {
                this.setState({
                  crosshairDataRecDescr: "",
          ...
          {this.isMobile ? (
            ...
            >
              ...
              <LineSeries
                ...
                onNearestX={(value, { index }) => {
                  this.setState({
                    crosshairDataWilshireIndex: otherChartCrosshairVal(
                      wilshire24moPerformance,
                      wilshireIndex,
                      index
                    ),
                ...
                itemsFormat={d => [
                  {
                    ...
                    value: math.format(d[4].y, 3) + "%"
                  },
                  {
                    title: "18-mo FUTURE Performance",
                    value: math.format(d[5].y, 3) + "%"
                  },
                  {
                    title: "24-mo FUTURE Performance",
                    value: math.format(d[6].y, 3) + "%"
                  }
                ]}
              />
            </FlexibleXYPlot>
