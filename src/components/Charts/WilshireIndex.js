...
class WilshireIndex extends Component {
  ...
  render() {
    //console.log("[WilshireIndex.js] Rendering...");
    ...
    return (
      <Fragment>
        ...
        >
          ...
          <LineSeries
            data={this.props.lineSeriesData}
            color="#800080"
            onNearestX={this.props.onNearestX}
          />
          <DiscreteColorLegend
